...
<body id="page-top">
		...
		<div class="container h-100">
			<div
				...
				<div class="col-lg-10 align-self-end">
					<h1 class="text-uppercase text-white font-weight-bold">Cloud
						Computing Project 1</h1>
				...
				<div class="col-lg-8 align-self-baseline">
					<form method="post" action="Home">
						...
						<input type="submit"
							class="btn btn-primary btn-xl js-scroll-trigger" id="btn1"
							name="btn1" />
					</form>
				</div>
			</div>
	...
	<footer class="bg-light py-5 grad">
		<div class="container">
			<div class="small text-center" style="color: white !important">Cloud
				Computing - Project 1 - AWS Web App</div>
		</div>
	</footer>
